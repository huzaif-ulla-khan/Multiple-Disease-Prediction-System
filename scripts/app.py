...
# Breast Cancer Prediction Page
    ...
    st.markdown("### Please enter the following medical parameters:")

    # 30 input fields for prediction
    input_values = []
    for feature in [
        ...
        value = st.number_input(f"{feature.replace('_', ' ').title()}", format="%.5f")
    ...
    if st.button("Breast Cancer Test Result"):
        ...
        if cancer_prediction[0] == 1:
            st.error("The model predicts that the patient has **Breast Cancer**.")
        else:
